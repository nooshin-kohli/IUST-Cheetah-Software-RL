#ifndef PROJECT_IUSTUSERPARAMETERS_H
#define PROJECT_IUSTUSERPARAMETERS_H

#include "ControlParameters/ControlParameters.h"

class IUST_UserParameters : public ControlParameters {
public:
  IUST_UserParameters()
...
#endif //PROJECT_IUSTUSERPARAMETERS_H
