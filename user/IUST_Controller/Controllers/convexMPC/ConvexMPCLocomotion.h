...
public:
  ...
  ConvexMPCLocomotion(float _dt, int _iterations_between_mpc, IUST_UserParameters* parameters, float fmax, RobotType& robotType);
  void initialize();
...
private:
  ...
  IUST_UserParameters* _parameters = nullptr;
