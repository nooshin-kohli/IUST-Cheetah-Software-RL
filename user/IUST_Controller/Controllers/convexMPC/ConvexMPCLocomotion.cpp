...
ConvexMPCLocomotion::ConvexMPCLocomotion(float _dt, int _iterations_between_mpc, IUST_UserParameters* parameters, float fmax, RobotType &robotType) :
...
//    }std::cout<<"\n";
  ...
  //cout << "dtMPC: " << dtMPC << "\n";
  update_problem_data_floats(p,v,q,w,r,yaw,weights,trajAll,alpha,mpcTable,iust_flag);
...
void ConvexMPCLocomotion::initIUSTSparseMPC() {
  Mat3<double> baseInertia;
